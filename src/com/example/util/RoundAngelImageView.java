...
public class RoundAngelImageView extends ImageView { 
    ...
    public RoundAngelImageView(Context context, AttributeSet attrs) { 
        super(context, attrs); 
        init(context, attrs); 
    } 
    ...
    private void init(Context context, AttributeSet attrs) { 
        if(attrs != null) {    
            ...
            roundHeight= a.getDimensionPixelSize(R.styleable.RoundAngelImageView_roundHeight, roundHeight); 
        }else { 
