...
public class RoundImageView extends ImageView {
	...
	private void setCustomAttributes(AttributeSet attrs) {
		...
		mBorderOutsideColor = a
				.getColor(R.styleable.roundedimageview_roundedimageview_border_outside_color, 
						defaultColor);
		mBorderInsideColor = a.getColor(
				R.styleable.roundedimageview_roundedimageview_border_inside_color, defaultColor);
	}
